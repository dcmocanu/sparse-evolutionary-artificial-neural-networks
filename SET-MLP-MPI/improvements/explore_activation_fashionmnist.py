...
weights = np.load("../Results/set_mlp_sequential_softmax_fashionmnist_keep_grads_60000_training_weights.npz",  allow_pickle=True)
biases = np.load("../Results/set_mlp_sequential_softmax_fashionmnist_keep_grads_60000_training_biases.npz", allow_pickle=True)
w10 = weights['arr_99'].item()
b10 = biases['arr_99'].item()
