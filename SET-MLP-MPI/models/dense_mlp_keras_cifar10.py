...
class MLP_CIFAR10:
    ...
    def fit(self, x, y_true, x_test, y_test, batch_size=10):
...
if __name__ == '__main__':
    ...
    # create and run a SET-MLP model on Cifar 10
    model = MLP_CIFAR10()
    ...
    np.savetxt("../Results/dense_mlp_keras_one_cpu_cifar10.txt", np.asarray(model.accuracies_per_epoch))
