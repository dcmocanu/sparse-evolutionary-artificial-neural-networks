...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "/home/dmocanu/MyGithubRepositories/sparse-evolutionary-artificial-neural-networks/SET-MLP-Sparse-Python-Data-Structures/sparseoperations.pyx"
        ]
    },
...
static PyMethodDef __pyx_mdef_16sparseoperations_1backpropagation_updates_Cython = {"backpropagation_updates_Cython", (PyCFunction)__pyx_pw_16sparseoperations_1backpropagation_updates_Cython, METH_VARARGS|METH_KEYWORDS, 0};
 ...
 */
      ...
      __pyx_t_6 = -1;
      if (unlikely(__pyx_t_7 >= (size_t)__pyx_pybuffernd_a.diminfo[0].shape)) __pyx_t_6 = 0;
      if (__pyx_t_8 < 0) {
        __pyx_t_8 += __pyx_pybuffernd_a.diminfo[1].shape;
        if (unlikely(__pyx_t_8 < 0)) __pyx_t_6 = 1;
      } else if (unlikely(__pyx_t_8 >= __pyx_pybuffernd_a.diminfo[1].shape)) __pyx_t_6 = 1;
      if (unlikely(__pyx_t_6 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_6);
        __PYX_ERR(0, 13, __pyx_L1_error)
      }
      ...
      __pyx_t_6 = -1;
      if (unlikely(__pyx_t_10 >= (size_t)__pyx_pybuffernd_delta.diminfo[0].shape)) __pyx_t_6 = 0;
      if (__pyx_t_11 < 0) {
        __pyx_t_11 += __pyx_pybuffernd_delta.diminfo[1].shape;
        if (unlikely(__pyx_t_11 < 0)) __pyx_t_6 = 1;
      } else if (unlikely(__pyx_t_11 >= __pyx_pybuffernd_delta.diminfo[1].shape)) __pyx_t_6 = 1;
      if (unlikely(__pyx_t_6 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_6);
        __PYX_ERR(0, 13, __pyx_L1_error)
      }
      __pyx_v_s = (__pyx_v_s + ((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_a.rcbuffer->pybuffer.buf, __pyx_t_7, __pyx_pybuffernd_a.diminfo[0].strides, __pyx_t_8, __pyx_pybuffernd_a.diminfo[1].strides)) * (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_delta.rcbuffer->pybuffer.buf, __pyx_t_10, __pyx_pybuffernd_delta.diminfo[0].strides, __pyx_t_11, __pyx_pybuffernd_delta.diminfo[1].strides))));
    }
 ...
 */
    ...
    *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_out.rcbuffer->pybuffer.buf, __pyx_t_4, __pyx_pybuffernd_out.diminfo[0].strides) = (__pyx_v_s / (__pyx_v_a->dimensions[0]));
  }
 ...
 *         size_t i,j
 */
  __pyx_tuple__10 = PyTuple_Pack(8, __pyx_n_s_a, __pyx_n_s_delta, __pyx_n_s_rows, __pyx_n_s_cols, __pyx_n_s_out, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_s); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(5, 0, 8, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_sparseoperations_pyx, __pyx_n_s_backpropagation_updates_Cython, 6, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
